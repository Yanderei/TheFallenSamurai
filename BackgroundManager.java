...
public class BackgroundManager {
	...
	private String bgImages[] = {"images/bg_images/0.png",
			       	     "images/bg_images/1.png",
				     "images/bg_images/2.png",
				     "images/bg_images/3.png",
				     "images/bg_images/4.png",
				     "images/bg_images/5.png",
				     "images/bg_images/6.png",
			       	 "images/bg_images/7.png",
					 "images/bg_images/8.png",
					 "images/bg_images/9.png", 
					 "images/bg_images/10.png",
					 "images/bg_images/11.png"};

  	private int moveAmount[] = {1, 1, 1, 2, 4, 4, 4, 4, 4, 5, 5, 10};  
  	...
  	private JFrame window;			// JPanel on which backgrounds are drawn
